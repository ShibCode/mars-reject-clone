...
const Navigation2 = () => {
  ...
  return (
    <>
      ...
      <div className="h-[78px] w-[0px] fixed z-50 bottom-[6vh] left-1/2 -translate-x-1/2 flex overflow-y-clip">
        <a
          href="#"
        ...
        >
          ...
          <div
            className={`absolute w-full h-full bg-[#f74a53] rounded-full flex justify-center items-center gap-0.5 transition-opacity 
              duration-[350ms] group-hover:duration-[200ms] ${
